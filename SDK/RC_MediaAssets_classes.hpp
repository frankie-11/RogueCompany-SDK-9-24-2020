...
public:
	...
	unsigned char                                      UnknownData00[0x3];                                       // 0x0630(0x0003) FIX WRONG TYPE SIZE OF PREVIUS PROPERTY
	unsigned char                                      DynamicRateAdjustment;                                    // 0x0634(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              RateAdjustmentFactor;                                     // 0x0638(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	struct FFloatRange                                 RateAdjustmentRange;                                      // 0x063C(0x0010) (Edit, ZeroConstructor, IsPlainOldData)
	class UMediaPlayer*                                MediaPlayer;                                              // 0x0650(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x1E8];                                     // 0x0658(0x01E8) MISSED OFFSET
