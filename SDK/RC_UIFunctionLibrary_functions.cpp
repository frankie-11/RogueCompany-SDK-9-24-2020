...
// Parameters:
// EKSPlayerInputType*            InputType                      (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
// class UObject**                __WorldContext                 (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
// class UTexture2D*              Texture                        (Parm, OutParm, ZeroConstructor, IsPlainOldData)

void UUIFunctionLibrary_C::STATIC_GetInputTypeIcon(EKSPlayerInputType* InputType, class UObject** __WorldContext, class UTexture2D** Texture)
{
...
void UUIFunctionLibrary_C::STATIC_GetPlatformIcon(EKSPlatformType* Platform, class UObject** __WorldContext, class UTexture2D** Icon)
{
...
// (Static, Public, HasOutParms, BlueprintCallable, BlueprintEvent, BlueprintPure)
// Parameters:
// class UClass**                 Damage_Type                    (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
// class UObject**                __WorldContext                 (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
// class UTexture2D*              Resisted_Icon                  (Parm, OutParm, ZeroConstructor, IsPlainOldData)
...
void UUIFunctionLibrary_C::STATIC_GetRarityFormatByTag(struct FGameplayTagContainer* GameplayTagContainer, class UObject** __WorldContext, struct FText* RarityFormat)
{
...
// (Static, Public, HasOutParms, HasDefaults, BlueprintCallable, BlueprintEvent, BlueprintPure)
// Parameters:
// struct FName*                  FontName                       (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
// class UObject**                __WorldContext                 (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
// bool                           HasFound                       (Parm, OutParm, ZeroConstructor, IsPlainOldData)
// struct FSlateFontInfo          FontInfo                       (Parm, OutParm)

void UUIFunctionLibrary_C::STATIC_GetFontByName(struct FName* FontName, class UObject** __WorldContext, bool* HasFound, struct FSlateFontInfo* FontInfo)
{
...
// (Static, Public, HasOutParms, HasDefaults, BlueprintCallable, BlueprintEvent, BlueprintPure)
// Parameters:
// struct FName*                  ColorName                      (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
// class UObject**                __WorldContext                 (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
// bool                           HasFound                       (Parm, OutParm, ZeroConstructor, IsPlainOldData)
// struct FLinearColor            Color                          (Parm, OutParm, ZeroConstructor, IsPlainOldData)

void UUIFunctionLibrary_C::STATIC_GetColorByName(struct FName* ColorName, class UObject** __WorldContext, bool* HasFound, struct FLinearColor* Color)
{
...
void UUIFunctionLibrary_C::STATIC_GetRarityHighlightColorByTag(struct FGameplayTagContainer* GameplayTagContainer, class UObject** __WorldContext, struct FSlateColor* RarityColor)
{
...
// Parameters:
// class UObject**                __WorldContext                 (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
// struct FUIColorPalette_v2      ColorPalette                   (Parm, OutParm)
...
// Parameters:
// struct FGameplayTag*           WeaponTypeTag                  (BlueprintVisible, BlueprintReadOnly, Parm)
// class UObject**                __WorldContext                 (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
// struct FText                   Text                           (Parm, OutParm)

void UUIFunctionLibrary_C::STATIC_GetWeaponTypeAsText(struct FGameplayTag* WeaponTypeTag, class UObject** __WorldContext, struct FText* Text)
{
