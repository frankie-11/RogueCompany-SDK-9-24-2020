...
public:
	...
	void STATIC_GetInputTypeIcon(EKSPlayerInputType* InputType, class UObject** __WorldContext, class UTexture2D** Texture);
	void STATIC_GetPlatformIcon(EKSPlatformType* Platform, class UObject** __WorldContext, class UTexture2D** Icon);
	void STATIC_GetDamageTypeResistIcon(class UClass** Damage_Type, class UObject** __WorldContext, class UTexture2D** Resisted_Icon);
	void STATIC_GetRarityFormatByTag(struct FGameplayTagContainer* GameplayTagContainer, class UObject** __WorldContext, struct FText* RarityFormat);
	void STATIC_GetFontByName(struct FName* FontName, class UObject** __WorldContext, bool* HasFound, struct FSlateFontInfo* FontInfo);
	void STATIC_GetColorByName(struct FName* ColorName, class UObject** __WorldContext, bool* HasFound, struct FLinearColor* Color);
	void STATIC_GetRarityHighlightColorByTag(struct FGameplayTagContainer* GameplayTagContainer, class UObject** __WorldContext, struct FSlateColor* RarityColor);
	void STATIC_GetColorPalette_v2(class UObject** __WorldContext, struct FUIColorPalette_v2* ColorPalette);
	void STATIC_GetWeaponTypeAsText(struct FGameplayTag* WeaponTypeTag, class UObject** __WorldContext, struct FText* Text);
