...
// (Final, Native, Public, BlueprintCallable)
// Parameters:
// bool*                          bEnableRetainedRendering       (Parm, ZeroConstructor, IsPlainOldData)

void URetainerBox::SetRetainedRendering(bool* bEnableRetainedRendering)
{
	static auto fn = UObject::FindObject<UFunction>("Function UMG.RetainerBox.SetRetainedRendering");
