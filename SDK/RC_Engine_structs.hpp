...
{
	TArray<struct FName>                               FreeNames;                                                // 0x0000(0x0010) (ZeroConstructor, Transient)
};
...
{
	int                                                FramesLeft;                                               // 0x0000(0x0004) (ZeroConstructor, Transient, IsPlainOldData)
	class UClass*                                      MyClass;                                                  // 0x0008(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
	struct FName                                       MyName;                                                   // 0x0010(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
};
...
{
	TMap<class UClass*, struct FHirezObjectPoolItem>   PoolsByClass;                                             // 0x0000(0x0050) (ZeroConstructor, Transient)
	TArray<struct FHirezObjectPoolQueuedEntry>         QueuedEntries;                                            // 0x0050(0x0010) (ZeroConstructor, Transient)
...
{
	unsigned char                                      Default : 1;                                              // 0x0000(0x0001) (Edit, BlueprintVisible BITFIELD: 0101)
	unsigned char                                      Friendly : 1;                                             // 0x0000(0x0001) (Edit, BlueprintVisible BITFIELD: 0202)
	unsigned char                                      Enemy : 1;                                                // 0x0000(0x0001) (Edit, BlueprintVisible BITFIELD: 0404)
	unsigned char                                      TaskForce1 : 1;                                           // 0x0000(0x0001) (Edit, BlueprintVisible BITFIELD: 0808)
	unsigned char                                      TaskForce2 : 1;                                           // 0x0000(0x0001) (Edit, BlueprintVisible BITFIELD: 1010)
	unsigned char                                      VerticalTargeter : 1;                                     // 0x0001(0x0001) (Edit, BlueprintVisible BITFIELD: 0101)
	unsigned char                                      LocalOwner : 1;                                           // 0x0001(0x0001) (Edit, BlueprintVisible BITFIELD: 0202)
	unsigned char                                      NotLocalOwner : 1;                                        // 0x0001(0x0001) (Edit, BlueprintVisible BITFIELD: 0404)
	unsigned char                                      CustomFilter1 : 1;                                        // 0x0002(0x0001) (Edit, BlueprintVisible BITFIELD: 0101)
	unsigned char                                      CustomFilter2 : 1;                                        // 0x0002(0x0001) (Edit, BlueprintVisible BITFIELD: 0202)
	unsigned char                                      CustomFilter3 : 1;                                        // 0x0002(0x0001) (Edit, BlueprintVisible BITFIELD: 0404)
	unsigned char                                      CustomFilter4 : 1;                                        // 0x0002(0x0001) (Edit, BlueprintVisible BITFIELD: 0808)
	unsigned char                                      CustomFilter5 : 1;                                        // 0x0002(0x0001) (Edit, BlueprintVisible BITFIELD: 1010)
};
...
struct FMaterialInstanceBasePropertyOverrides
{
	...
	unsigned char                                      bOverride_MaterialSSR : 1;                                // 0x0000(0x0001) (Edit BITFIELD: 4040)
	unsigned char                                      MaterialSSR : 1;                                          // 0x0000(0x0001) (Edit BITFIELD: 8080)
	unsigned char                                      bOverride_HQForwardReflections : 1;                       // 0x0001(0x0001) (Edit BITFIELD: 0101)
	unsigned char                                      HQForwardReflections : 1;                                 // 0x0001(0x0001) (Edit BITFIELD: 0202)
	unsigned char                                      TwoSided : 1;                                             // 0x0001(0x0001) (Edit BITFIELD: 0404)
	unsigned char                                      DitheredLODTransition : 1;                                // 0x0001(0x0001) (Edit BITFIELD: 0808)
	unsigned char                                      bCastDynamicShadowAsMasked : 1;                           // 0x0001(0x0001) (Edit BITFIELD: 1010)
...
struct FLightmassLightSettings
{
	...
	unsigned char                                      bExcludeFromVolumetricLightmap;                           // 0x0009(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
};
...
struct FSkeletalMeshLODGroupSettings
{
	...
	struct FPerPlatformBool                            bUseExtraBonesToRemove;                                   // 0x0020(0x0001) (Edit)
	TArray<struct FBoneFilter>                         ExtraBonesToRemove;                                       // 0x0028(0x0010) (Edit, ZeroConstructor)
	TArray<struct FName>                               BonesToPrioritize;                                        // 0x0038(0x0010) (Edit, ZeroConstructor)
	float                                              WeightOfPrioritization;                                   // 0x0048(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	class UAnimSequence*                               BakePose;                                                 // 0x0050(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	struct FSkeletalMeshOptimizationSettings           ReductionSettings;                                        // 0x0058(0x003C) (Edit)
};
...
struct FSoundClassProperties
{
	...
	unsigned char                                      bApplyInsulationVolumes : 1;                              // 0x0028(0x0001) (Edit BITFIELD: 0404)
...
struct FMeshMergingSettings
{
	...
	unsigned char                                      bPivotPointAtRoot;                                        // 0x008A(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bAverageRootLocationsForFinalPivot;                       // 0x008B(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bSplitForComplexity;                                      // 0x008C(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bMergePhysicsData : 1;                                    // 0x008D(0x0001) (Edit, BlueprintVisible BITFIELD: 0101)
	unsigned char                                      bMergeMaterials : 1;                                      // 0x008D(0x0001) (Edit, BlueprintVisible BITFIELD: 0202)
	unsigned char                                      bCreateMergedMaterial : 1;                                // 0x008D(0x0001) (Edit, BlueprintVisible BITFIELD: 0404)
	unsigned char                                      bBakeVertexDataToMesh : 1;                                // 0x008D(0x0001) (Edit, BlueprintVisible BITFIELD: 0808)
	unsigned char                                      bUseVertexDataForBakingMaterial : 1;                      // 0x008D(0x0001) (Edit, BlueprintVisible BITFIELD: 1010)
	unsigned char                                      bUseTextureBinning : 1;                                   // 0x008D(0x0001) (Edit, BlueprintVisible BITFIELD: 2020)
	unsigned char                                      bReuseMeshLightmapUVs : 1;                                // 0x008D(0x0001) (Edit BITFIELD: 4040)
	unsigned char                                      bMergeEquivalentMaterials : 1;                            // 0x008D(0x0001) (Edit BITFIELD: 8080)
	unsigned char                                      bUseLandscapeCulling : 1;                                 // 0x008E(0x0001) (Edit, BlueprintVisible BITFIELD: 0101)
	unsigned char                                      bIncludeImposters : 1;                                    // 0x008E(0x0001) (Edit, BlueprintVisible BITFIELD: 0202)
	unsigned char                                      bAllowDistanceField : 1;                                  // 0x008E(0x0001) (Edit BITFIELD: 0404)
};
...
struct FHierarchicalSimplification
{
	...
	struct FMeshMergingSettings                        MergeSetting;                                             // 0x00A0(0x0090) (Edit)
	float                                              DesiredBoundRadius;                                       // 0x0130(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              DesiredFillingPercentage;                                 // 0x0134(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	int                                                MinNumberOfActorsToBuild;                                 // 0x0138(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
};
...
struct FMeshBuildSettings
{
	...
	unsigned char                                      bSmoothNormalsInVertexColor : 1;                          // 0x0000(0x0001) (Edit BITFIELD: 8080)
	unsigned char                                      bUseHighPrecisionTangentBasis : 1;                        // 0x0001(0x0001) (Edit BITFIELD: 0101)
	unsigned char                                      bUseFullPrecisionUVs : 1;                                 // 0x0001(0x0001) (Edit BITFIELD: 0202)
	unsigned char                                      bGenerateLightmapUVs : 1;                                 // 0x0001(0x0001) (Edit BITFIELD: 0404)
	unsigned char                                      bGenerateDistanceFieldAsIfTwoSided : 1;                   // 0x0001(0x0001) (Edit BITFIELD: 0808)
...
struct FLightmassWorldInfoSettings
{
	...
	unsigned char                                      bEnableGpuLightmass;                                      // 0x004C(0x0001) (Edit, ZeroConstructor, Config, IsPlainOldData)
