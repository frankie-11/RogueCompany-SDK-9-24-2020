...
public:
	...
	unsigned char                                      bCheckPlatformOSSForUpdate;                               // 0x0098(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      bCheckOSSForUpdate;                                       // 0x0099(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	...
	unsigned char                                      bPlatformEnvironmentDetected;                             // 0x00A8(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      bInitialUpdateFinished;                                   // 0x00A9(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      bCheckHotfixAvailabilityOnly;                             // 0x00AA(0x0001) (ZeroConstructor, IsPlainOldData)
