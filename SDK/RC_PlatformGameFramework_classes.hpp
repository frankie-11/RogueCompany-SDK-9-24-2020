...
public:
	...
	class UPGame_EffectManagerComponent*               m_EffectManager;                                          // 0x0638(0x0008) (Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, IsPlainOldData)
	struct FTweenInfo                                  r_TweenInfo;                                              // 0x0640(0x0014) (Net)
	struct FChargeInfo                                 r_ChargeInfo;                                             // 0x0654(0x001C) (Net)
...
public:
	...
	unsigned char                                      bUseTweenWalkingPhysics;                                  // 0x06F0(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	struct FChargeInfo                                 r_ChargeInfo;                                             // 0x06F8(0x001C) (Edit, DisableEditOnTemplate, Transient, EditConst)
	struct FTweenInfo                                  r_TweenInfo;                                              // 0x0714(0x0014) (Edit, DisableEditOnTemplate, Transient, EditConst)
...
{
public:
	struct FString                                     LogFileName;                                              // 0x0218(0x0010) (Edit, BlueprintVisible, ZeroConstructor)
...
public:
	...
	struct FPGame_PersistentEffectRepDataContainer     r_ReplicatedEffectData;                                   // 0x00D8(0x0120) (Edit, Net, DisableEditOnTemplate, EditConst)
	struct FPGame_EffectManagerPropertyContainer       r_ReplicatedProperties;                                   // 0x01F8(0x0170) (Edit, Net)
...
public:
	...
	unsigned char                                      UnknownData00[0x3];                                       // 0x0088(0x0003) FIX WRONG TYPE SIZE OF PREVIUS PROPERTY
	unsigned char                                      m_nMaxStackCount;                                         // 0x008C(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      m_bApplyInstantOnInterval;                                // 0x008D(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      m_bApplyStackOnInterval;                                  // 0x008E(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
...
public:
	...
	unsigned char                                      m_bApplyOnInternal;                                       // 0x004C(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
...
public:
	...
	unsigned char                                      bStartHotfixProcessingOnUpdateAppSettings;                // 0x01E8(0x0001) (ZeroConstructor, Config, GlobalConfig, IsPlainOldData)
...
public:
	...
	unsigned char                                      bAutoEnableCombatLog;                                     // 0x0380(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      bUploadCombatLogOverride;                                 // 0x0381(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData01[0x3E];                                      // 0x0382(0x003E) MISSED OFFSET
	unsigned char                                      bFubarForCPUFramerate;                                    // 0x03C0(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      bFubarForPacketLoss;                                      // 0x03C1(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	float                                              FubarShutdownWaitTimeoutTime;                             // 0x03C4(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData02[0x8];                                       // 0x03C8(0x0008) MISSED OFFSET
	TArray<struct FPGame_InactivePlayerStateEntry>     PGame_InactivePlayerArray;                                // 0x03D0(0x0010) (ZeroConstructor, Transient)
...
{
public:
	struct FScriptMulticastDelegate                    OnHandlerObjectReady;                                     // 0x0028(0x0001) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData00[0xF];                                       // 0x0028(0x000F) FIX WRONG TYPE SIZE OF PREVIUS PROPERTY
	struct FScriptMulticastDelegate                    OnJsonDownloaded;                                         // 0x0038(0x0001) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData01[0xF];                                       // 0x0038(0x000F) FIX WRONG TYPE SIZE OF PREVIUS PROPERTY
	struct FScriptMulticastDelegate                    OnImagesDownloaded;                                       // 0x0048(0x0001) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData02[0xF];                                       // 0x0048(0x000F) FIX WRONG TYPE SIZE OF PREVIUS PROPERTY
	unsigned char                                      UnknownData03[0xB8];                                      // 0x0058(0x00B8) MISSED OFFSET
...
{
public:
	class UClass*                                      m_CheatComponentClass;                                    // 0x0580(0x0008) (ZeroConstructor, IsPlainOldData)
	class UPGame_CheatComponent*                       r_CheatComponent;                                         // 0x0588(0x0008) (ExportObject, Net, ZeroConstructor, InstancedReference, IsPlainOldData)
	struct FSerializedMctsNetId                        r_ReplicatedNetId;                                        // 0x0590(0x0008) (Net)
	class UClass*                                      InputComponentClass;                                      // 0x0598(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
...
{
public:
	unsigned char                                      bRestrictInvalidInputType;                                // 0x0028(0x0001) (ZeroConstructor, Config, IsPlainOldData)
...
public:
	...
	unsigned char                                      UnknownData01[0x14];                                      // 0x131C(0x0014) MISSED OFFSET
...
{
public:
	EPositionHistoryRecordMode                         PositionRecordMode;                                       // 0x00B0(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      ExtrapolateFromLastEntry;                                 // 0x00B1(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      bAutoPopulateOnBeginPlay;                                 // 0x00B2(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData00[0x15];                                      // 0x00B3(0x0015) MISSED OFFSET
	TArray<struct FPrimitivePriority>                  TrackedPrimitives;                                        // 0x00C8(0x0010) (ZeroConstructor, Transient)
...
{
public:
	TArray<class UClass*>                              ActorsToAlwaysSpawn;                                      // 0x0398(0x0010) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Config)
