...
{
	struct FName                                       SkinKeyword;                                              // 0x0098(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UPoseAsset*                                  TargetPose;                                               // 0x00A0(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
	unsigned char                                      bUsePoseAssetPinAsFallback;                               // 0x00A8(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UPoseAsset*                                  FallbackPose;                                             // 0x00B0(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
...
struct FAnimNode_BlendSpacePlayerSkinned : public FAnimNode_BlendSpacePlayer
{
	...
	unsigned char                                      bLastHadTargetBlendSpace;                                 // 0x0188(0x0001) (ZeroConstructor, IsPlainOldData)
	...
	unsigned char                                      bResetSourceOnActivation;                                 // 0x01D8(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x17];                                      // 0x01D9(0x0017) MISSED OFFSET
};
...
struct FAnimNode_BSpaceEvalSkinned : public FAnimNode_BlendSpaceEvaluator
{
	...
	unsigned char                                      bLastHadTargetBlendSpace;                                 // 0x0190(0x0001) (ZeroConstructor, IsPlainOldData)
	...
	unsigned char                                      bResetSourceOnActivation;                                 // 0x01E0(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x17];                                      // 0x01E1(0x0017) MISSED OFFSET
};
...
struct FAnimNode_SeqEvalSkinned : public FAnimNode_SequenceEvaluator
{
	...
	unsigned char                                      bUseSequencePinAsFallback;                                // 0x00F0(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bLastHadTargetSequence;                                   // 0x00F1(0x0001) (ZeroConstructor, IsPlainOldData)
	...
	unsigned char                                      bResetSourceOnActivation;                                 // 0x0140(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
...
struct FAnimNode_SequenceSkinned : public FAnimNode_AssetPlayerBase
{
	...
	unsigned char                                      bLoopAnimation;                                           // 0x0048(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	...
	unsigned char                                      bLastHadSequence;                                         // 0x00E8(0x0001) (ZeroConstructor, IsPlainOldData)
	...
	unsigned char                                      bResetSourceOnActivation;                                 // 0x0138(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
