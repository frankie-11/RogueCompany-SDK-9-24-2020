...
struct FRecoilInfo
{
	...
	unsigned char                                      Enabled;                                                  // 0x005C(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      Mirrored;                                                 // 0x005D(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
};
...
struct FAnimOrientationWarpDefinition
{
	...
	unsigned char                                      UseBoneSpaceForSpineWarp;                                 // 0x0001(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
...
struct FKSAnimNode_OrientationWarp : public FAnimNode_SkeletalControlBase
{
	...
	float                                              OrientationAlphaOverride;                                 // 0x00CC(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FAnimOrientationWarpDefinition              WarpSettings;                                             // 0x00D0(0x0038) (Edit)
	unsigned char                                      bUseOrientationAlphaOverride;                             // 0x0108(0x0001) (ZeroConstructor, IsPlainOldData)
};
...
struct FKSAnimNode_Recoil : public FAnimNode_SkeletalControlBase
{
	...
	unsigned char                                      m_bBoneSpaceRecoil;                                       // 0x00D8(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	...
	unsigned char                                      m_bApplyControl;                                          // 0x0144(0x0001) (ZeroConstructor, Transient, IsPlainOldData)
	...
	unsigned char                                      UnknownData01[0xC];                                       // 0x018C(0x000C) MISSED OFFSET
